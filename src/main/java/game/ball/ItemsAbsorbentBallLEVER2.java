...
public class ItemsAbsorbentBallLEVER2 extends ItemsAbsorbentBallLEVER5 {
    public ItemsAbsorbentBallLEVER2(String name, String description, double timeuse, double percent) {
        super("Bóng Hấp Thụ(Cấp 2)","Mỗi khi quả bóng bất kì va chạm gạch," +
