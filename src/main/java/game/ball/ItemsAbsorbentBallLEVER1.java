...
public class ItemsAbsorbentBallLEVER1 extends ItemsAbsorbentBallLEVER5 {
    ...
    public ItemsAbsorbentBallLEVER1() {
        super("Bóng Hấp Thụ(Cấp 1)",
                "Hiệu lực 10s. Khi nhặt: tạo 1 bóng mới trên sân. Khi bóng MỚI va chạm gạch, nó được buff +5 damege vĩnh viễn.",
                10, 25);
    }
    @Override
    ...
    public void onBrickCollision(Ball collidingBall, List<Ball> allBalls, List<Bricks> allBricks, List<Ball> pendingBalls) {
        if (collidingBall.isSpecialPowerupBall()) {
            collidingBall.setDamege(collidingBall.getDamege()+1);
        }
    }
    @Override
